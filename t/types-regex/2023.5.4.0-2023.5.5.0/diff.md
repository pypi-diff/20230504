# Comparing `tmp/types-regex-2023.5.4.0.tar.gz` & `tmp/types-regex-2023.5.5.0.tar.gz`
...
## Comparing `types-regex-2023.5.4.0.tar` & `types-regex-2023.5.5.0.tar`
...
### Comparing `types-regex-2023.5.4.0/CHANGELOG.md` & `types-regex-2023.5.5.0/CHANGELOG.md`
...
### Comparing `types-regex-2023.5.4.0/PKG-INFO` & `types-regex-2023.5.5.0/PKG-INFO`
...
### Comparing `types-regex-2023.5.4.0/regex-stubs/_regex.pyi` & `types-regex-2023.5.5.0/regex-stubs/_regex.pyi`

 * *Files identical despite different names*

### Comparing `types-regex-2023.5.4.0/regex-stubs/_regex_core.pyi` & `types-regex-2023.5.5.0/regex-stubs/_regex_core.pyi`

 * *Files identical despite different names*

### Comparing `types-regex-2023.5.4.0/regex-stubs/regex.pyi` & `types-regex-2023.5.5.0/regex-stubs/regex.pyi`

 * *Files identical despite different names*

### Comparing `types-regex-2023.5.4.0/setup.py` & `types-regex-2023.5.5.0/setup.py`
...
### Comparing `types-regex-2023.5.4.0/types_regex.egg-info/PKG-INFO` & `types-regex-2023.5.5.0/types_regex.egg-info/PKG-INFO`
