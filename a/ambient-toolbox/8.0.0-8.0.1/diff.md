# Comparing `tmp/ambient-toolbox-8.0.0.tar.gz` & `tmp/ambient-toolbox-8.0.1.tar.gz`
...
### Comparing `ambient-toolbox-8.0.0/Dockerfile` & `ambient-toolbox-8.0.1/Dockerfile`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/LICENSE.md` & `ambient-toolbox-8.0.1/LICENSE.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/README.md` & `ambient-toolbox-8.0.1/README.md`
...
### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/admin/model_admins/classes.py` & `ambient-toolbox-8.0.1/ambient_toolbox/admin/model_admins/classes.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/admin/model_admins/inlines.py` & `ambient-toolbox-8.0.1/ambient_toolbox/admin/model_admins/inlines.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/admin/model_admins/mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/admin/model_admins/mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/admin/views/forms.py` & `ambient-toolbox-8.0.1/ambient_toolbox/admin/views/forms.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/admin/views/mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/admin/views/mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/context_manager.py` & `ambient-toolbox-8.0.1/ambient_toolbox/context_manager.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/drf/fields.py` & `ambient-toolbox-8.0.1/ambient_toolbox/drf/fields.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/drf/serializers.py` & `ambient-toolbox-8.0.1/ambient_toolbox/drf/serializers.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/drf/tests.py` & `ambient-toolbox-8.0.1/ambient_toolbox/drf/tests.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/gitlab/coverage.py` & `ambient-toolbox-8.0.1/ambient_toolbox/gitlab/coverage.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/graphql/forms/mutations.py` & `ambient-toolbox-8.0.1/ambient_toolbox/graphql/forms/mutations.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/graphql/schemes/mutations.py` & `ambient-toolbox-8.0.1/ambient_toolbox/graphql/schemes/mutations.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/graphql/sentry/views.py` & `ambient-toolbox-8.0.1/ambient_toolbox/graphql/sentry/views.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/graphql/tests/base_test.py` & `ambient-toolbox-8.0.1/ambient_toolbox/graphql/tests/base_test.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/locale/de/LC_MESSAGES/django.mo` & `ambient-toolbox-8.0.1/ambient_toolbox/locale/de/LC_MESSAGES/django.mo`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/locale/de/LC_MESSAGES/django.po` & `ambient-toolbox-8.0.1/ambient_toolbox/locale/de/LC_MESSAGES/django.po`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/mail/backends/whitelist_smtp.py` & `ambient-toolbox-8.0.1/ambient_toolbox/mail/backends/whitelist_smtp.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/managers.py` & `ambient-toolbox-8.0.1/ambient_toolbox/managers.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/middleware/current_user.py` & `ambient-toolbox-8.0.1/ambient_toolbox/middleware/current_user.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/mixins/bleacher.py` & `ambient-toolbox-8.0.1/ambient_toolbox/mixins/bleacher.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/mixins/models.py` & `ambient-toolbox-8.0.1/ambient_toolbox/mixins/models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/models.py` & `ambient-toolbox-8.0.1/ambient_toolbox/models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/selectors/permission.py` & `ambient-toolbox-8.0.1/ambient_toolbox/selectors/permission.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/sentry/helpers.py` & `ambient-toolbox-8.0.1/ambient_toolbox/sentry/helpers.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/services/custom_scrubber.py` & `ambient-toolbox-8.0.1/ambient_toolbox/services/custom_scrubber.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/templatetags/ai_email_tags.py` & `ambient-toolbox-8.0.1/ambient_toolbox/templatetags/ai_email_tags.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/templatetags/ai_file_tags.py` & `ambient-toolbox-8.0.1/ambient_toolbox/templatetags/ai_file_tags.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/templatetags/ai_number_tags.py` & `ambient-toolbox-8.0.1/ambient_toolbox/templatetags/ai_number_tags.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/templatetags/ai_string_tags.py` & `ambient-toolbox-8.0.1/ambient_toolbox/templatetags/ai_string_tags.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/tests/mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/tests/mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/tests/structure_validator/test_structure_validator.py` & `ambient-toolbox-8.0.1/ambient_toolbox/tests/structure_validator/test_structure_validator.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/utils/date.py` & `ambient-toolbox-8.0.1/ambient_toolbox/utils/date.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/utils/file.py` & `ambient-toolbox-8.0.1/ambient_toolbox/utils/file.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/utils/math.py` & `ambient-toolbox-8.0.1/ambient_toolbox/utils/math.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/utils/model.py` & `ambient-toolbox-8.0.1/ambient_toolbox/utils/model.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/utils/named_tuple.py` & `ambient-toolbox-8.0.1/ambient_toolbox/utils/named_tuple.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/utils/string.py` & `ambient-toolbox-8.0.1/ambient_toolbox/utils/string.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/view_layer/form_mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/view_layer/form_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/view_layer/formset_view_mixin.py` & `ambient-toolbox-8.0.1/ambient_toolbox/view_layer/formset_view_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/view_layer/htmx_mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/view_layer/htmx_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/view_layer/mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/view_layer/mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/view_layer/tests/mixins.py` & `ambient-toolbox-8.0.1/ambient_toolbox/view_layer/tests/mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/ambient_toolbox/view_layer/views.py` & `ambient-toolbox-8.0.1/ambient_toolbox/view_layer/views.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/Makefile` & `ambient-toolbox-8.0.1/docs/Makefile`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/conf.py` & `ambient-toolbox-8.0.1/docs/conf.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/admin.md` & `ambient-toolbox-8.0.1/docs/features/admin.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/context_manager.md` & `ambient-toolbox-8.0.1/docs/features/context_manager.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/context_processors.md` & `ambient-toolbox-8.0.1/docs/features/context_processors.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/database_anonymisation.md` & `ambient-toolbox-8.0.1/docs/features/database_anonymisation.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/djangorestframework.md` & `ambient-toolbox-8.0.1/docs/features/djangorestframework.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/gitlab.md` & `ambient-toolbox-8.0.1/docs/features/gitlab.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/graphql.md` & `ambient-toolbox-8.0.1/docs/features/graphql.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/mail.md` & `ambient-toolbox-8.0.1/docs/features/mail.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/managers.md` & `ambient-toolbox-8.0.1/docs/features/managers.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/mixins.md` & `ambient-toolbox-8.0.1/docs/features/mixins.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/models.md` & `ambient-toolbox-8.0.1/docs/features/models.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/selectors.md` & `ambient-toolbox-8.0.1/docs/features/selectors.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/sentry.md` & `ambient-toolbox-8.0.1/docs/features/sentry.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/services.md` & `ambient-toolbox-8.0.1/docs/features/services.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/setup.md` & `ambient-toolbox-8.0.1/docs/features/setup.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/tests.md` & `ambient-toolbox-8.0.1/docs/features/tests.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/utils/cache.md` & `ambient-toolbox-8.0.1/docs/features/utils/cache.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/utils/date.md` & `ambient-toolbox-8.0.1/docs/features/utils/date.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/utils/math.md` & `ambient-toolbox-8.0.1/docs/features/utils/math.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/utils/model.md` & `ambient-toolbox-8.0.1/docs/features/utils/model.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/utils/named_tuple.md` & `ambient-toolbox-8.0.1/docs/features/utils/named_tuple.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/utils/string.md` & `ambient-toolbox-8.0.1/docs/features/utils/string.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/features/view-layer.md` & `ambient-toolbox-8.0.1/docs/features/view-layer.md`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/index.rst` & `ambient-toolbox-8.0.1/docs/index.rst`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/docs/make.bat` & `ambient-toolbox-8.0.1/docs/make.bat`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/manage.py` & `ambient-toolbox-8.0.1/manage.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/pyproject.toml` & `ambient-toolbox-8.0.1/pyproject.toml`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/settings.py` & `ambient-toolbox-8.0.1/settings.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/testapp/api/views.py` & `ambient-toolbox-8.0.1/testapp/api/views.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/testapp/migrations/0001_initial.py` & `ambient-toolbox-8.0.1/testapp/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/testapp/models.py` & `ambient-toolbox-8.0.1/testapp/models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/testapp/templates/403.html` & `ambient-toolbox-8.0.1/testapp/templates/403.html`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_admin_common_info_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_admin_common_info_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_admin_create_form_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_admin_create_form_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_admin_no_inlines_for_create_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_admin_no_inlines_for_create_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_admin_request_in_form_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_admin_request_in_form_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_deactivatable_change_view_admin_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_deactivatable_change_view_admin_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_fetch_object_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_fetch_object_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/admin/model_admin_mixins/test_fetch_parent_object_inline_mixin.py` & `ambient-toolbox-8.0.1/tests/admin/model_admin_mixins/test_fetch_parent_object_inline_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/ambient_toolbox/test_test_structure_validator.py` & `ambient-toolbox-8.0.1/tests/ambient_toolbox/test_test_structure_validator.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/drf/test_fields.py` & `ambient-toolbox-8.0.1/tests/drf/test_fields.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/query_selectors/test_permission.py` & `ambient-toolbox-8.0.1/tests/query_selectors/test_permission.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_admin_forms.py` & `ambient-toolbox-8.0.1/tests/test_admin_forms.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_admin_inlines.py` & `ambient-toolbox-8.0.1/tests/test_admin_inlines.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_admin_model_admins_classes.py` & `ambient-toolbox-8.0.1/tests/test_admin_model_admins_classes.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_admin_view_mixins.py` & `ambient-toolbox-8.0.1/tests/test_admin_view_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_context_manager.py` & `ambient-toolbox-8.0.1/tests/test_context_manager.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_log_whodid.py` & `ambient-toolbox-8.0.1/tests/test_log_whodid.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_managers.py` & `ambient-toolbox-8.0.1/tests/test_managers.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_math.py` & `ambient-toolbox-8.0.1/tests/test_math.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_middleware.py` & `ambient-toolbox-8.0.1/tests/test_middleware.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_mixins_models.py` & `ambient-toolbox-8.0.1/tests/test_mixins_models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_models.py` & `ambient-toolbox-8.0.1/tests/test_models.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_rest_api_mixins.py` & `ambient-toolbox-8.0.1/tests/test_rest_api_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_scrubbing_service.py` & `ambient-toolbox-8.0.1/tests/test_scrubbing_service.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_sentry_helper.py` & `ambient-toolbox-8.0.1/tests/test_sentry_helper.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_utils_date.py` & `ambient-toolbox-8.0.1/tests/test_utils_date.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_utils_file.py` & `ambient-toolbox-8.0.1/tests/test_utils_file.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_utils_model.py` & `ambient-toolbox-8.0.1/tests/test_utils_model.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_utils_named_tuple.py` & `ambient-toolbox-8.0.1/tests/test_utils_named_tuple.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/test_utils_string.py` & `ambient-toolbox-8.0.1/tests/test_utils_string.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/tests/mixins/test_django_message_framework.py` & `ambient-toolbox-8.0.1/tests/tests/mixins/test_django_message_framework.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/tests/mixins/test_request_provider_mixin.py` & `ambient-toolbox-8.0.1/tests/tests/mixins/test_request_provider_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/tests/test_mail_backends.py` & `ambient-toolbox-8.0.1/tests/tests/test_mail_backends.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/view_layer/test_formset_mixins.py` & `ambient-toolbox-8.0.1/tests/view_layer/test_formset_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/view_layer/test_htmx_response_mixin.py` & `ambient-toolbox-8.0.1/tests/view_layer/test_htmx_response_mixin.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/view_layer/test_meta_mixins.py` & `ambient-toolbox-8.0.1/tests/view_layer/test_meta_mixins.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/tests/view_layer/test_views.py` & `ambient-toolbox-8.0.1/tests/view_layer/test_views.py`

 * *Files identical despite different names*

### Comparing `ambient-toolbox-8.0.0/PKG-INFO` & `ambient-toolbox-8.0.1/PKG-INFO`
