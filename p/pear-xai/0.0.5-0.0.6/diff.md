# Comparing `tmp/pear-xai-0.0.5.tar.gz` & `tmp/pear-xai-0.0.6.tar.gz`
...
### Comparing `pear-xai-0.0.5/LICENSE` & `pear-xai-0.0.6/LICENSE`
...
### Comparing `pear-xai-0.0.5/captum/_utils/models/linear_model/train.py` & `pear-xai-0.0.6/captum/_utils/models/linear_model/train.py`
...
### Comparing `pear-xai-0.0.5/captum/attr/_core/guided_backprop_deconvnet.py` & `pear-xai-0.0.6/captum/attr/_core/guided_backprop_deconvnet.py`
...
### Comparing `pear-xai-0.0.5/captum/attr/_core/layer/layer_deep_lift.py` & `pear-xai-0.0.6/captum/attr/_core/layer/layer_deep_lift.py`
...
### Comparing `pear-xai-0.0.5/pear/__init__.py` & `pear-xai-0.0.6/pear/__init__.py`
...
### Comparing `pear-xai-0.0.5/pear/datasets/electricity/electricity-test.csv` & `pear-xai-0.0.6/pear/datasets/electricity/electricity-test.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/datasets/electricity/electricity-train.csv` & `pear-xai-0.0.6/pear/datasets/electricity/electricity-train.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/disagreement_loss.py` & `pear-xai-0.0.6/pear/disagreement_loss.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/disagreement_metrics.py` & `pear-xai-0.0.6/pear/disagreement_metrics.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/example.py` & `pear-xai-0.0.6/pear/example.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/explainers.py` & `pear-xai-0.0.6/pear/explainers.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/models.py` & `pear-xai-0.0.6/pear/models.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear/tools.py` & `pear-xai-0.0.6/pear/tools.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pear_xai.egg-info/PKG-INFO` & `pear-xai-0.0.6/pear_xai.egg-info/PKG-INFO`
...
### Comparing `pear-xai-0.0.5/pear_xai.egg-info/SOURCES.txt` & `pear-xai-0.0.6/pear_xai.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.5/pyproject.toml` & `pear-xai-0.0.6/pyproject.toml`
