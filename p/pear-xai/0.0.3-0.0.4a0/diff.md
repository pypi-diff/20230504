# Comparing `tmp/pear-xai-0.0.3.tar.gz` & `tmp/pear-xai-0.0.4a0.tar.gz`
...
### Comparing `pear-xai-0.0.3/captum/_utils/models/linear_model/model.py` & `pear-xai-0.0.4a0/captum/_utils/models/linear_model/model.py`
...
### Comparing `pear-xai-0.0.3/captum/attr/_core/gradient_shap.py` & `pear-xai-0.0.4a0/captum/attr/_core/gradient_shap.py`
...
### Comparing `pear-xai-0.0.3/captum/attr/_core/layer/layer_conductance.py` & `pear-xai-0.0.4a0/captum/attr/_core/layer/layer_conductance.py`
...
### Comparing `pear-xai-0.0.3/captum/attr/_core/shapley_value.py` & `pear-xai-0.0.4a0/captum/attr/_core/shapley_value.py`
...
### Comparing `pear-xai-0.0.3/captum/attr/_utils/stat.py` & `pear-xai-0.0.4a0/captum/attr/_utils/stat.py`
...
### Comparing `pear-xai-0.0.3/captum/influence/_core/influence.py` & `pear-xai-0.0.4a0/captum/influence/_core/influence.py`
...
### Comparing `pear-xai-0.0.3/notebooks/pear-training-experiment.ipynb` & `pear-xai-0.0.4a0/notebooks/pear-training-experiment.ipynb`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/notebooks/quickstart.ipynb` & `pear-xai-0.0.4a0/notebooks/quickstart.ipynb`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/__init__.py` & `pear-xai-0.0.4a0/pear/__init__.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/datasets/bankmarketing/bankmarketing-test.csv` & `pear-xai-0.0.4a0/pear/datasets/bankmarketing/bankmarketing-test.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/datasets/bankmarketing/bankmarketing-train.csv` & `pear-xai-0.0.4a0/pear/datasets/bankmarketing/bankmarketing-train.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/datasets/californiahousing/californiahousing-test.csv` & `pear-xai-0.0.4a0/pear/datasets/californiahousing/californiahousing-test.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/datasets/californiahousing/californiahousing-train.csv` & `pear-xai-0.0.4a0/pear/datasets/californiahousing/californiahousing-train.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/datasets/electricity/electricity-test.csv` & `pear-xai-0.0.4a0/pear/datasets/electricity/electricity-test.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/datasets/electricity/electricity-train.csv` & `pear-xai-0.0.4a0/pear/datasets/electricity/electricity-train.csv`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/disagreement_loss.py` & `pear-xai-0.0.4a0/pear/disagreement_loss.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/disagreement_metrics.py` & `pear-xai-0.0.4a0/pear/disagreement_metrics.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/example.py` & `pear-xai-0.0.4a0/pear/example.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/explainers.py` & `pear-xai-0.0.4a0/pear/explainers.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/models.py` & `pear-xai-0.0.4a0/pear/models.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear/tools.py` & `pear-xai-0.0.4a0/pear/tools.py`

 * *Files identical despite different names*

### Comparing `pear-xai-0.0.3/pear_xai.egg-info/PKG-INFO` & `pear-xai-0.0.4a0/pear_xai.egg-info/PKG-INFO`
...
### Comparing `pear-xai-0.0.3/pear_xai.egg-info/SOURCES.txt` & `pear-xai-0.0.4a0/pear_xai.egg-info/SOURCES.txt`
...
### Comparing `pear-xai-0.0.3/pyproject.toml` & `pear-xai-0.0.4a0/pyproject.toml`
