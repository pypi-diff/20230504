# Comparing `tmp/pyvium-0.1.4b0.tar.gz` & `tmp/pyvium-0.1.5b0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "pyvium-0.1.4b0.tar", max compression
+gzip compressed data, was "pyvium-0.1.5b0.tar", max compression
```

## Comparing `pyvium-0.1.4b0.tar` & `pyvium-0.1.5b0.tar`

### file list

```diff
@@ -1,20 +1,26 @@
--rw-r--r--   0        0        0      618 2023-02-13 12:29:09.992636 pyvium-0.1.4b0/LICENSE
--rw-r--r--   0        0        0     1415 2023-02-13 12:29:10.001637 pyvium-0.1.4b0/pyproject.toml
--rw-r--r--   0        0        0       52 2023-02-13 12:29:10.045638 pyvium-0.1.4b0/pyvium/__init__.py
--rw-r--r--   0        0        0    23486 2023-02-13 12:29:10.046638 pyvium-0.1.4b0/pyvium/core.py
--rw-r--r--   0        0        0      325 2023-02-13 12:29:10.046638 pyvium-0.1.4b0/pyvium/errors/__init__.py
--rw-r--r--   0        0        0      197 2023-02-13 12:29:10.047636 pyvium-0.1.4b0/pyvium/errors/cell_off.py
--rw-r--r--   0        0        0      317 2023-02-13 12:29:10.047636 pyvium-0.1.4b0/pyvium/errors/device_busy.py
--rw-r--r--   0        0        0      298 2023-02-13 12:29:10.047636 pyvium-0.1.4b0/pyvium/errors/device_not_connected_to_iviumsoft.py
--rw-r--r--   0        0        0      272 2023-02-13 12:29:10.048636 pyvium-0.1.4b0/pyvium/errors/driver_not_open.py
--rw-r--r--   0        0        0      289 2023-02-13 12:29:10.048636 pyvium-0.1.4b0/pyvium/errors/no_device_detected.py
--rw-r--r--   0        0        0      269 2023-02-13 12:29:10.048636 pyvium-0.1.4b0/pyvium/errors/no_iviumsoft_running.py
--rw-r--r--   0        0        0  5131844 2023-02-13 12:29:10.031671 pyvium-0.1.4b0/pyvium/IVIUM_remdriver.dll
--rw-r--r--   0        0        0  2187264 2023-02-13 12:29:10.045638 pyvium-0.1.4b0/pyvium/Ivium_remdriver64.dll
--rw-r--r--   0        0        0    19297 2023-02-13 12:29:10.049636 pyvium-0.1.4b0/pyvium/pyvium.py
--rw-r--r--   0        0        0     1941 2023-02-13 12:29:10.049636 pyvium-0.1.4b0/pyvium/pyvium_verifiers.py
--rw-r--r--   0        0        0       52 2023-02-13 12:29:10.049636 pyvium-0.1.4b0/pyvium/util/__init__.py
--rw-r--r--   0        0        0      477 2023-02-13 12:29:10.050636 pyvium-0.1.4b0/pyvium/util/get_ivium_dll_path.py
--rw-r--r--   0        0        0     1620 2023-02-13 12:29:09.992636 pyvium-0.1.4b0/README.md
--rw-r--r--   0        0        0     2355 1970-01-01 00:00:00.000000 pyvium-0.1.4b0/setup.py
--rw-r--r--   0        0        0     2400 1970-01-01 00:00:00.000000 pyvium-0.1.4b0/PKG-INFO
...
### Comparing `pyvium-0.1.4b0/LICENSE` & `pyvium-0.1.5b0/LICENSE`

 * *Files identical despite different names*

### Comparing `pyvium-0.1.4b0/pyproject.toml` & `pyvium-0.1.5b0/pyproject.toml`
...
### Comparing `pyvium-0.1.4b0/pyvium/IVIUM_remdriver.dll` & `pyvium-0.1.5b0/pyvium/IVIUM_remdriver.dll`

 * *Files identical despite different names*

### Comparing `pyvium-0.1.4b0/pyvium/Ivium_remdriver64.dll` & `pyvium-0.1.5b0/pyvium/Ivium_remdriver64.dll`

 * *Files identical despite different names*

### Comparing `pyvium-0.1.4b0/pyvium/pyvium.py` & `pyvium-0.1.5b0/pyvium/pyvium.py`

 * *Files identical despite different names*

### Comparing `pyvium-0.1.4b0/pyvium/pyvium_verifiers.py` & `pyvium-0.1.5b0/pyvium/pyvium_verifiers.py`

 * *Files identical despite different names*

### Comparing `pyvium-0.1.4b0/README.md` & `pyvium-0.1.5b0/README.md`

 * *Files identical despite different names*

### Comparing `pyvium-0.1.4b0/setup.py` & `pyvium-0.1.5b0/setup.py`
...
### Comparing `pyvium-0.1.4b0/PKG-INFO` & `pyvium-0.1.5b0/PKG-INFO`
