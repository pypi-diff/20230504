# Comparing `tmp/PICNIK-0.1.6.tar.gz` & `tmp/PICNIK-0.1.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "PICNIK-0.1.6.tar", max compression
+gzip compressed data, was "PICNIK-0.1.7.tar", max compression
```

## Comparing `PICNIK-0.1.6.tar` & `PICNIK-0.1.7.tar`

### file list

```diff
@@ -1,6 +1,6 @@
--rw-r--r--   0        0        0     1074 2021-09-25 21:35:05.028501 PICNIK-0.1.6/LICENSE
--rw-r--r--   0        0        0     3757 2022-03-04 06:36:33.169397 PICNIK-0.1.6/README.md
--rw-r--r--   0        0        0    84067 2022-03-18 19:25:47.981210 PICNIK-0.1.6/picnik.py
--rw-r--r--   0        0        0      702 2022-06-06 21:55:43.324081 PICNIK-0.1.6/pyproject.toml
--rw-r--r--   0        0        0     4579 2022-06-06 21:55:52.680136 PICNIK-0.1.6/setup.py
--rw-r--r--   0        0        0     4677 2022-06-06 21:55:52.681150 PICNIK-0.1.6/PKG-INFO
...
### Comparing `PICNIK-0.1.6/LICENSE` & `PICNIK-0.1.7/LICENSE`

 * *Files identical despite different names*

### Comparing `PICNIK-0.1.6/README.md` & `PICNIK-0.1.7/README.md`

 * *Files identical despite different names*

### Comparing `PICNIK-0.1.6/picnik.py` & `PICNIK-0.1.7/picnik.py`

 * *Files identical despite different names*

### Comparing `PICNIK-0.1.6/setup.py` & `PICNIK-0.1.7/setup.py`
...
### Comparing `PICNIK-0.1.6/PKG-INFO` & `PICNIK-0.1.7/PKG-INFO`
...
+Requires-Python: >=3.7,<4.0
 ...
 Requires-Dist: derivative (>=0.3.1,<0.4.0)
