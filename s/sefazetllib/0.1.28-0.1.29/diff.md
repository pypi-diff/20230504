# Comparing `tmp/sefazetllib-0.1.28.tar.gz` & `tmp/sefazetllib-0.1.29.tar.gz`
...
## Comparing `sefazetllib-0.1.28.tar` & `sefazetllib-0.1.29.tar`
...
### Comparing `sefazetllib-0.1.28/LICENSE` & `sefazetllib-0.1.29/LICENSE`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/pyproject.toml` & `sefazetllib-0.1.29/pyproject.toml`
...
### Comparing `sefazetllib-0.1.28/README.md` & `sefazetllib-0.1.29/README.md`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/Builder.py` & `sefazetllib-0.1.29/sefazetllib/Builder.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/config/CustomLogging.py` & `sefazetllib-0.1.29/sefazetllib/config/CustomLogging.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/etl/ETL.py` & `sefazetllib-0.1.29/sefazetllib/etl/ETL.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/extract/Extract.py` & `sefazetllib-0.1.29/sefazetllib/extract/Extract.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/extract/ExtractLocal.py` & `sefazetllib-0.1.29/sefazetllib/extract/ExtractLocal.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/extract/ExtractS3.py` & `sefazetllib-0.1.29/sefazetllib/extract/ExtractS3.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/extract/ExtractSQL.py` & `sefazetllib-0.1.29/sefazetllib/extract/ExtractSQL.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/extract/ExtractStorage.py` & `sefazetllib-0.1.29/sefazetllib/extract/ExtractStorage.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/factory/Factory.py` & `sefazetllib-0.1.29/sefazetllib/factory/Factory.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/factory/platform/database/MySQL.py` & `sefazetllib-0.1.29/sefazetllib/factory/platform/database/MySQL.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/factory/platform/database/PostgreSQL.py` & `sefazetllib-0.1.29/sefazetllib/factory/platform/database/PostgreSQL.py`
...
### Comparing `sefazetllib-0.1.28/sefazetllib/factory/platform/dataframe/Pandas.py` & `sefazetllib-0.1.29/sefazetllib/factory/platform/dataframe/Pandas.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/factory/platform/dataframe/Spark.py` & `sefazetllib-0.1.29/sefazetllib/factory/platform/dataframe/Spark.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/factory/platform/PlatformFactory.py` & `sefazetllib-0.1.29/sefazetllib/factory/platform/PlatformFactory.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/load/Load.py` & `sefazetllib-0.1.29/sefazetllib/load/Load.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/load/LoadLocal.py` & `sefazetllib-0.1.29/sefazetllib/load/LoadLocal.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/load/LoadS3.py` & `sefazetllib-0.1.29/sefazetllib/load/LoadS3.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/load/LoadSQL.py` & `sefazetllib-0.1.29/sefazetllib/load/LoadSQL.py`
...
### Comparing `sefazetllib-0.1.28/sefazetllib/load/LoadStorage.py` & `sefazetllib-0.1.29/sefazetllib/load/LoadStorage.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/transform/MinMaxLineTransform.py` & `sefazetllib-0.1.29/sefazetllib/transform/MinMaxLineTransform.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/transform/QuartileTransform.py` & `sefazetllib-0.1.29/sefazetllib/transform/QuartileTransform.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/transform/Transform.py` & `sefazetllib-0.1.29/sefazetllib/transform/Transform.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/utils/key/SurrogateKey.py` & `sefazetllib-0.1.29/sefazetllib/utils/key/SurrogateKey.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/utils/partition/DatePartition.py` & `sefazetllib-0.1.29/sefazetllib/utils/partition/DatePartition.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/utils/partition/IncrementalRangePartition.py` & `sefazetllib-0.1.29/sefazetllib/utils/partition/IncrementalRangePartition.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllib/validate/DataValidate.py` & `sefazetllib-0.1.29/sefazetllib/validate/DataValidate.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/__init__.py` & `sefazetllib-0.1.29/sefazetllibcli/__init__.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/config/logging.py` & `sefazetllib-0.1.29/sefazetllibcli/config/logging.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/generators/etl_generator.py` & `sefazetllib-0.1.29/sefazetllibcli/generators/etl_generator.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/generators/generator.py` & `sefazetllib-0.1.29/sefazetllibcli/generators/generator.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/__init__.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/__init__.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_etl_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_etl_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_extract_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_extract_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_imports_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_imports_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_key_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_key_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_load_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_load_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_partition_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_partition_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_transforms_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_transforms_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_validate_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_validate_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/process_variable/process_variable.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/process_variable/process_variable.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/replace_template/replace_etl_template.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/replace_template/replace_etl_template.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/usecases/replace_template/replace_template.py` & `sefazetllib-0.1.29/sefazetllibcli/usecases/replace_template/replace_template.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/sefazetllibcli/utils/parse_etl.py` & `sefazetllib-0.1.29/sefazetllibcli/utils/parse_etl.py`

 * *Files identical despite different names*

### Comparing `sefazetllib-0.1.28/setup.py` & `sefazetllib-0.1.29/setup.py`
...
### Comparing `sefazetllib-0.1.28/PKG-INFO` & `sefazetllib-0.1.29/PKG-INFO`
