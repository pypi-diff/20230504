# Comparing `tmp/dagster-airbyte-0.19.3.tar.gz` & `tmp/dagster-airbyte-1.0.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dagster-airbyte-0.19.3.tar", last modified: Thu May  4 17:52:17 2023, max compression
+gzip compressed data, was "dagster-airbyte-1.0.5.tar", last modified: Fri Aug 26 13:45:14 2022, max compression
```

## Comparing `dagster-airbyte-0.19.3.tar` & `dagster-airbyte-1.0.5.tar`

### file list

```diff
@@ -1,33 +1,23 @@
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-05-04 17:52:17.272465 dagster-airbyte-0.19.3/
--rw-r--r--   0 root         (0) root         (0)    11344 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/LICENSE
--rw-r--r--   0 root         (0) root         (0)       67 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/MANIFEST.in
--rw-r--r--   0 root         (0) root         (0)      716 2023-05-04 17:52:17.272465 dagster-airbyte-0.19.3/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      131 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/README.md
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-05-04 17:52:17.264465 dagster-airbyte-0.19.3/dagster_airbyte/
--rw-r--r--   0 root         (0) root         (0)     1215 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/__init__.py
--rw-r--r--   0 root         (0) root         (0)    43955 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/asset_defs.py
--rw-r--r--   0 root         (0) root         (0)      425 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/cli.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-05-04 17:52:17.268465 dagster-airbyte-0.19.3/dagster_airbyte/managed/
--rw-r--r--   0 root         (0) root         (0)      423 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/managed/__init__.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-05-04 17:52:17.268465 dagster-airbyte-0.19.3/dagster_airbyte/managed/generated/
--rw-r--r--   0 root         (0) root         (0)       76 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/managed/generated/__init__.py
--rw-r--r--   0 root         (0) root         (0)   119751 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/managed/generated/destinations.py
--rw-r--r--   0 root         (0) root         (0)   282784 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/managed/generated/sources.py
--rw-r--r--   0 root         (0) root         (0)    33410 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/managed/reconciliation.py
--rw-r--r--   0 root         (0) root         (0)    14161 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/managed/types.py
--rw-r--r--   0 root         (0) root         (0)     4128 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/ops.py
--rw-r--r--   0 root         (0) root         (0)        8 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/py.typed
--rw-r--r--   0 root         (0) root         (0)    25736 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/resources.py
--rw-r--r--   0 root         (0) root         (0)     1434 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/types.py
--rw-r--r--   0 root         (0) root         (0)     2633 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/utils.py
--rw-r--r--   0 root         (0) root         (0)       23 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/dagster_airbyte/version.py
-drwxr-xr-x   0 root         (0) root         (0)        0 2023-05-04 17:52:17.264465 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/
--rw-r--r--   0 root         (0) root         (0)      716 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/PKG-INFO
--rw-r--r--   0 root         (0) root         (0)      809 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/SOURCES.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/dependency_links.txt
--rw-r--r--   0 root         (0) root         (0)       61 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/entry_points.txt
--rw-r--r--   0 root         (0) root         (0)        1 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/not-zip-safe
--rw-r--r--   0 root         (0) root         (0)       90 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/requires.txt
--rw-r--r--   0 root         (0) root         (0)       16 2023-05-04 17:52:17.000000 dagster-airbyte-0.19.3/dagster_airbyte.egg-info/top_level.txt
--rw-r--r--   0 root         (0) root         (0)      162 2023-05-04 17:52:17.272465 dagster-airbyte-0.19.3/setup.cfg
--rw-r--r--   0 root         (0) root         (0)     1593 2023-05-04 17:42:14.000000 dagster-airbyte-0.19.3/setup.py
...
### Comparing `dagster-airbyte-0.19.3/LICENSE` & `dagster-airbyte-1.0.5/LICENSE`
...
### Comparing `dagster-airbyte-0.19.3/PKG-INFO` & `dagster-airbyte-1.0.5/PKG-INFO`
...
### Comparing `dagster-airbyte-0.19.3/dagster_airbyte/ops.py` & `dagster-airbyte-1.0.5/dagster_airbyte/ops.py`
...
### Comparing `dagster-airbyte-0.19.3/dagster_airbyte/utils.py` & `dagster-airbyte-1.0.5/dagster_airbyte/utils.py`
...
### Comparing `dagster-airbyte-0.19.3/dagster_airbyte.egg-info/PKG-INFO` & `dagster-airbyte-1.0.5/dagster_airbyte.egg-info/PKG-INFO`
...
### Comparing `dagster-airbyte-0.19.3/setup.py` & `dagster-airbyte-1.0.5/setup.py`
...
-        "managed": [
-            "dagster-managed-elements==0.19.3",
+        packages=find_packages(exclude=["dagster_airbyte_tests*"]),
+        install_requires=[
+            "dagster==1.0.5",
+            "requests",
